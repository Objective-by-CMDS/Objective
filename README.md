...
~~~sh
# getting the code
git clone git@github.com:nko4/moin.git && cd ./moin/

# developing
npm install
npm start

# deploying (to http://moin.2013.nodeknockout.com/)
./deploy nko

# ssh access
ssh deploy@moin.2013.nodeknockout.com
ssh root@moin.2013.nodeknockout.com
# or, if you get prompted for a password
ssh -i ./id_deploy deploy@moin.2013.nodeknockout.com
ssh -i ./id_deploy root@moin.2013.nodeknockout.com
~~~
...
~~~html
<iframe src="http://nodeknockout.com/iframe/moin" frameborder=0 scrolling=no allowtransparency=true width=115 height=25>
</iframe>
~~~
